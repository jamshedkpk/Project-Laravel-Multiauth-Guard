...
@section('content')
    ...
    <div class="content-header mb-4">
        <div class="row align-items-center">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">{{ __('Create Expense') }}</h1>
            </div>
            <div class="col-sm-6">
    ...
    <div class="content">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">{{ __('Add a new expense') }}</h3>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input type="text" class="form-control @error('expenseReason') is-invalid @enderror" id="expenseReason" name="expenseReason" placeholder="{{ __('Expense Reason') }}" value="{{ old('expenseReason') }}" required>
                                @error('expenseReason')
                                <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                ...
                                <input type="number" step="0.01" class="form-control @error('expenseAmount') is-invalid @enderror" id="expenseAmount" name="expenseAmount" placeholder="{{ __('Expense Amount') }}" value="{{ old('expenseAmount') }}" required>
                                @error('expenseAmount')
                                <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input type="date" placeholder="{{\Carbon\Carbon::today()->format('Y-m-d')}}" class="@error('expenseDate') is-invalid @enderror form-control" id="expenseDate" name="expenseDate" required>
                                @error('expenseDate')
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <textarea class="form-control @error('note') is-invalid @enderror" id="note" name="note" placeholder="{{ __('Expense Note') }}">{{ old('note') }}</textarea>
                                @error('note')
                                <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="row">
                            <div class="col-sm-10">
                                <button type="submit" class="btn btn-primary"><i class="fas fa-save"></i> {{ __('Save Expense') }}</button>
                            </div>
                        </div>
                    </div>
                    <!-- /.card-body -->
